...
const CardProduct = ({ product }) => {
  ...
  return (
    <div className="shadow-md rounded-xl shadow-[#0000003b] max-w-[480px] basis-[calc(50%-8px)] lg:basis-[calc(25%-24px)] lg:min-w-[212px]">
      ...
      <div className="p-2 lg:py-4 lg:px-6">
        ...
        <div className={product.precioFinal == undefined ? "hidden" : null}>
          ...
          <p className="text-lg lg:text-2xl font-medium -mt-1 lg:m-0">{`$ ${numberFormat(product.precioFinal)}`}</p>
        </div>
