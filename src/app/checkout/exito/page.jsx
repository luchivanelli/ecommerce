    ...
    <main className='p-3 lg:p-6 max-w-[1000px] mx-auto'>
      <div className='bg-[#508f821e] border-1 border-[#508f8281] rounded-md p-6 flex flex-col items-center'>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <a href='mailto:lucianavanelli13@gmail.com' target="_blank" rel="noopener noreferrer" className='text-sm lg:text-base bg-[#508f821e] border-1 border-[#508f8281] rounded-md font-medium py-2 px-4 cursor-pointer hover:scale-[99%] transition-all'>Contáctame</a>
          <a href='/' className='text-sm lg:text-base bg-[#508f821e] border-1 border-[#508f8281] rounded-md font-medium py-2 px-4 cursor-pointer hover:scale-[99%] transition-all'>Volver a la tienda</a>
        </div>
      </div>
    </main>
  )
